...
.. include:: scala-installations.rst
Multiple Scala Version Support
------------------------------

Do you have projects configured to use a legacy version of Scala ? Head
over to the `Multiple Scala Version Support page <./scala-installations.html>`_.
