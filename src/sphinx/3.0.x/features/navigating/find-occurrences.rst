...
It is possible to find all occurrences of a specific Scala entity by selecting the entity in the editor and press the shortcut ``Ctrl-Alt-Shift-R`` or ``Cmd-Alt-Shift-R``. Version 0.1 only supports find references for members, i.e., methods and fields.
...
.. image:: images/feature-find-occurrences-01.png
